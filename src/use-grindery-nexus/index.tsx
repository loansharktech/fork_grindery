...
export const GrinderyNexusContextProvider = (
  ...
  //   let tempObj ={
  //     "access_token": "eyJhbGciOiJFUzI1NiJ9.eyJhdWQiOiJ1cm46Z3JpbmRlcnk6YWNjZXNzLXRva2VuOnYxIiwic3ViIjoiZWlwMTU1OjE6MHhEODY0OUFhZUJjMUJkNjU3MTQxNTlmM2I1NjI2QTQ2OTlEMGVCN2VDIiwiaWF0IjoxNjgxMjI3NDI5LCJpc3MiOiJ1cm46Z3JpbmRlcnk6b3JjaGVzdHJhdG9yIiwiZXhwIjoxNjgxMjMxMDI5fQ.ZEoUX4gPEkeqJCYR7GA5d2QhTHyrGsYFSg4T2fe6TBC70IqOKeaUHqg4pIIEQ-mnRaSsVAczdbFkISzBtY_9gg",
  //     "token_type": "bearer",
  //     "expires_in": 3600
  // }
  //   setToken(tempObj);
